...
- **Выборочный подсчёт суммы:** чекбокс в каждой строке включает/исключает позицию из суммы в шрифте; чекбокс в заголовке столбца включает или отключает сразу все позиции (в состоянии «все включены» — повторный клик снимает все галочки; при изменении отдельной строки заголовок переходит в серое/неопределённое состояние)
